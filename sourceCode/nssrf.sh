...
python featureExtract.py $1  # generate subgraph feature, subgraph size can be 2, 3, 4 or 234
...
#            $3: dbStart: the start range of database
#            $4: dbEnd: the end range of database
#            $5: queryStart: the start range of query networks
#            $6: queryEnd: the end range of query networks
